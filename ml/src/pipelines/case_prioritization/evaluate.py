"""Evaluate the case prioritization predictive model on the holdout window."""
...
def evaluate_case_prioritization_model(
	*,
	dataset: pd.DataFrame | None = None,
	save_output: bool = True,
) -> dict[str, Any]:
	"""Evaluate case-prioritization predictions and persist validation evidence."""
...
def main() -> None:
	payload = evaluate_case_prioritization_model()
	metrics = payload["metrics"]
	print(
		"Case prioritization evaluation complete "
