"""Evaluate the home visitation outcome predictive model on the holdout window."""
...
def evaluate_home_visitation_outcome_model(
	*,
	dataset: pd.DataFrame | None = None,
	save_output: bool = True,
) -> dict[str, Any]:
	"""Evaluate home-visitation-outcome predictions and persist validation evidence."""
...
def main() -> None:
	payload = evaluate_home_visitation_outcome_model()
	metrics = payload["metrics"]
	print(
		"Home visitation outcome evaluation complete "
