"""Evaluate the resident risk predictive model on the holdout window."""
...
def evaluate_resident_risk_model(
    *,
    dataset: pd.DataFrame | None = None,
    save_output: bool = True,
) -> dict[str, Any]:
    """Evaluate resident risk predictions and persist validation evidence."""
...
def main() -> None:
    payload = evaluate_resident_risk_model()
    metrics = payload["metrics"]
    print(
        "Resident risk evaluation complete "
