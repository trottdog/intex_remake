"""Train the best posting time predictive model."""
...
from ml.src.pipelines.best_posting_time.build_dataset import build_dataset
...
def train_predictive_model() -> dict[str, float]:
    """Train the best-posting-time predictive model and save artifacts."""
