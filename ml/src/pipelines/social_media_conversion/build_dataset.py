"""Build the social media conversion dataset."""
...
def build_dataset(*, save_output: bool = True) -> pd.DataFrame:
    """Build the social-media-conversion modeling dataset."""

    config = load_pipeline_config(CONFIG_PATH)
    dataset = load_processed_table("post_features")
...
def main() -> None:
    ...
    print(f"Built social media conversion dataset with {len(dataset)} rows")
