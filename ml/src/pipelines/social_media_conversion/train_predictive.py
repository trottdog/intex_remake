"""Train the social media conversion predictive model."""
...
from ml.src.pipelines.social_media_conversion.build_dataset import build_dataset

CONFIG_PATH = Path(__file__).with_name("config.yaml")


def train_predictive_model() -> dict[str, float]:
    """Train the social-media-conversion predictive model and save artifacts."""
...
def main() -> None:
    ...
    print(
        "Trained social media conversion predictive model "
