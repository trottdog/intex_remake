"""Train the donor upgrade predictive model."""
...
from ml.src.pipelines.donor_upgrade.build_dataset import build_dataset

CONFIG_PATH = Path(__file__).with_name("config.yaml")


def train_predictive_model() -> dict[str, float]:
    """Train the donor-upgrade predictive model and save artifacts."""
