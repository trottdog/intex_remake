"""Train the capacity pressure predictive model."""
...
from ml.src.pipelines.capacity_pressure.build_dataset import build_dataset
...
def train_predictive_model() -> dict[str, float]:
    """Train the capacity-pressure predictive model and save artifacts."""
