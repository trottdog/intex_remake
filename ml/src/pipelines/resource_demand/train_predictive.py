"""Train the resource demand predictive model."""
...
from ml.src.pipelines.resource_demand.build_dataset import build_dataset

CONFIG_PATH = Path(__file__).with_name("config.yaml")


def train_predictive_model() -> dict[str, float]:
    """Train the resource-demand predictive model and save artifacts."""
