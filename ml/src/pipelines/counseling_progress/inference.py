"""Inference helpers for counseling progress."""
...
def score_counseling_progress(
	dataset: pd.DataFrame,
	*,
	include_features: bool = True,
) -> pd.DataFrame:
	"""Score counseling-progress rows and return prediction fields."""

	scored = predict_dataframe(dataset, pipeline_name="counseling_progress")
	if include_features:
		return scored
...
def score_latest_snapshot(
	*,
	...
	"""Build and score the latest counseling-progress snapshot rows."""
	...
	return score_counseling_progress(latest, include_features=include_features)
