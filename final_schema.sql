...
CREATE TABLE public.donations (
  donation_id bigint NOT NULL DEFAULT nextval('donations_donation_id_seq'::regclass),
  supporter_id bigint,
  donation_type text,
  donation_date date,
...
CREATE TABLE public.supporters (
  supporter_id bigint NOT NULL DEFAULT nextval('supporters_supporter_id_seq'::regclass),
  supporter_type text,
  display_name text,
